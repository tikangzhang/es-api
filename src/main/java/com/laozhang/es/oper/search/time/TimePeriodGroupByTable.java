...
public class TimePeriodGroupByTable extends Executor implements ITimePeriodGroupByTable, IWhere, IGroupBy, IResult, IPipGroupBy {
	public static Logger logger = LoggerFactory.getLogger(TimePeriodGroupByTable.class);
	...
	public TimePeriodGroupByTable(String dataBaseName){
		this(dataBaseName,null);
	}
	
	public TimePeriodGroupByTable(String dataBaseName, String tableName){
		this.dataBase = dataBaseName;
		this.table = tableName;
	}

	@Override
	public <T> TimePeriodGroupByTable WhereAnd(String k, T v) {
	...
	@Override
	public TimePeriodGroupByTable Where(BoolCondition bc) {
		boolCondition = bc;
	...
	@Override
	public <T> TimePeriodGroupByTable WhereOr(String k, T v) {
		if(null == boolCondition){
			boolCondition = new BoolCondition();
		}
	...
	@Override
	public <T> TimePeriodGroupByTable WhereNot(String k, T v) {
		if(null == boolCondition){
			boolCondition = new BoolCondition();
		}
	...
	@Override
	public <T> TimePeriodGroupByTable WhereAnd(BoolCondition condition) {
		if(null == boolCondition){
			boolCondition = new BoolCondition();
		}
	...
	@Override
	public <T> TimePeriodGroupByTable WhereOr(BoolCondition condition) {
		if(null == boolCondition){
			boolCondition = new BoolCondition();
		}
	...
	@Override
	public <T> TimePeriodGroupByTable WhereNot(BoolCondition condition) {
		if(null == boolCondition){
			boolCondition = new BoolCondition();
		}
	...
	@Override
	public TimePeriodGroupByTable WhereRange(String k, Object from, Object to) {
	...
	@Override
	public <T> TimePeriodGroupByTable WhereRange(String k, LogicRelation relation, T to) {
	...
	@Override
	public TimePeriodGroupByTable WhereRange(String k, Object from, Object to, String timeZone) {
		rangCondition = new RangeCondition(k);
		rangCondition.Gte(from).Lt(to);
	...
	@Override
	public TimePeriodGroupByTable WhereIsNotNull(String k) {
		if(null == boolCondition){
			boolCondition = new BoolCondition();
		}
	...
	@Override
	public TimePeriodGroupByTable WhereIsNull(String k) {
		if(null == boolCondition){
			boolCondition = new BoolCondition();
		}
		boolCondition.IsNotNull(k);;
	...
	@Override
	public TimePeriodGroupByTable StatByYear(String col) {
		if(StringUtils.isEmpty(col)){
			return this;
		}
		if(null == this.aggCondition){
			AggTimePeriodStatCondition atsc = new AggTimePeriodStatCondition(col);
			atsc.setFormater(AggTimePeriodStatCondition.DEFAULT_YEAR_FORMATER);
			atsc.setInterval(DateHistogramInterval.YEAR);
	...
	@Override
	public TimePeriodGroupByTable StatByMonth(String col) {
		if(StringUtils.isEmpty(col)){
			return this;
		}
		if(null == this.aggCondition){
			AggTimePeriodStatCondition atsc = new AggTimePeriodStatCondition(col);
			atsc.setFormater(CommonConstant.COMMON_TIME_UNIT_MONTH);
			atsc.setInterval(DateHistogramInterval.MONTH);
			this.aggCondition = atsc;
			logger.debug("stat by month,col:" + col);
		}
		return this;
	}

	@Override
	public TimePeriodGroupByTable StatByWeek(String col) {
		if(StringUtils.isEmpty(col)){
			return this;
		}
		if(null == this.aggCondition){
			AggTimePeriodStatCondition atsc = new AggTimePeriodStatCondition(col);
			atsc.setFormater(CommonConstant.COMMON_TIME_UNIT_WEEK);
			atsc.setInterval(DateHistogramInterval.WEEK);
			this.aggCondition = atsc;
			logger.debug("stat by week,col:" + col);
		}
		return this;
	}

	@Override
	public TimePeriodGroupByTable StatByDay(String col) {
		if(StringUtils.isEmpty(col)){
			return this;
		}
		if(null == this.aggCondition){
			AggTimePeriodStatCondition atsc = new AggTimePeriodStatCondition(col);
			atsc.setFormater(CommonConstant.COMMON_TIME_UNIT_DAY);
			atsc.setInterval(DateHistogramInterval.DAY);
			this.aggCondition = atsc;
			logger.debug("stat by day,col:" + col);
		}
		return this;
	}
	
	public TimePeriodGroupByTable StatByDay(String col, String dayFormater) {
		if(StringUtils.isEmpty(col)){
			return this;
		}
		if(null == this.aggCondition){
			AggTimePeriodStatCondition atsc = new AggTimePeriodStatCondition(col);
			atsc.setFormater(dayFormater);
			atsc.setInterval(DateHistogramInterval.DAY);
			this.aggCondition = atsc;
			logger.debug("stat by day,col:" + col);
		}
	...
	@Override
	public TimePeriodGroupByTable OrderBy(String alias, boolean desc){
		if(null != this.aggCondition) {
	...
	@Override
	public TimePeriodGroupByTable Sum(String col) {
		return Sum(col,AggSumCondition.DEFAULT_ALIAS_PREFIX.concat(col));
	}
	
	@Override
	public TimePeriodGroupByTable Sum(String col, Arithmetic opType, Object opNum) {
		return Sum(col, AggSumCondition.DEFAULT_ALIAS_PREFIX.concat(col),opType,opNum);
	}
	
	@Override
	public TimePeriodGroupByTable Sum(String col, String alias) {
		if(null == this.aggCondition){
	...
	@Override
	public TimePeriodGroupByTable Sum(String col, String alias, Arithmetic opType, Object opNum) {
		if(null == this.aggCondition){
			this.rootAggConditionList.add(new AggSumCondition(col,alias));
	...
	@Override
	public TimePeriodGroupByTable Avg(String col) {
		return Avg(col,AggAvgCondition.DEFAULT_ALIAS_PREFIX.concat(col));
	}
	
	@Override
	public TimePeriodGroupByTable Avg(String col, Arithmetic opType, Object opNum) {
		return Avg(col, AggAvgCondition.DEFAULT_ALIAS_PREFIX.concat(col),opType,opNum);
	}
	
	@Override
	public TimePeriodGroupByTable Avg(String col, String alias) {
		if(null == this.aggCondition){
	...
	@Override
	public TimePeriodGroupByTable Avg(String col, String alias, Arithmetic opType, Object opNum) {
		if(null == this.aggCondition){
			this.rootAggConditionList.add(new AggAvgCondition(col,alias));
	...
	@Override
	public TimePeriodGroupByTable Max(String col) {
		return Max(col,AggMaxCondition.DEFAULT_ALIAS_PREFIX.concat(col));
	}
	
	@Override
	public TimePeriodGroupByTable Max(String col, Arithmetic opType, Object opNum) {
		return Max(col,AggMaxCondition.DEFAULT_ALIAS_PREFIX.concat(col),opType,opNum);
	}
	
	@Override
	public TimePeriodGroupByTable Max(String col, String alias) {
		if(null == this.aggCondition){
	...
	@Override
	public TimePeriodGroupByTable Max(String col, String alias, Arithmetic opType, Object opNum) {
		if(null == this.aggCondition){
			this.rootAggConditionList.add(new AggMaxCondition(col,alias));
	...
	@Override
	public TimePeriodGroupByTable Min(String col) {
		return Min(col,AggMinCondition.DEFAULT_ALIAS_PREFIX.concat(col));
	}
	
	@Override
	public TimePeriodGroupByTable Min(String col, Arithmetic opType, Object opNum) {
		return Min(col,AggMinCondition.DEFAULT_ALIAS_PREFIX.concat(col),opType,opNum);
	}
	
	@Override
	public TimePeriodGroupByTable Min(String col, String alias) {
		if(null == this.aggCondition){
	...
	@Override
	public TimePeriodGroupByTable Min(String col, String alias, Arithmetic opType, Object opNum) {
		if(null == this.aggCondition){
			this.rootAggConditionList.add(new AggMinCondition(col,alias));
	...
	@Override
	public TimePeriodGroupByTable Count(String col) {
		return Count(col,AggCountCondition.DEFAULT_ALIAS_PREFIX.concat(col));
	}
	
	@Override
	public TimePeriodGroupByTable Count(String col, String alias) {
		if(null == this.aggCondition){
	...
	@Override
	public TimePeriodGroupByTable DistinctCount(String col) {
		return DistinctCount(col,AggDistinctCountCondition.DEFAULT_ALIAS_PREFIX.concat(col));
	}

	@Override
	public TimePeriodGroupByTable DistinctCount(String col, String alias) {
		if(null == this.aggCondition){
	...
	@Override
	public TimePeriodGroupByTable setMainKey(String key) {
		this.key = key;
		return this;
	}
	...
	private void getData(Aggregations aggs,Map<String,Object> mainMap,List<Map<String,Object>> refList,Map<String,String> aliasMap){
		...
		while(ir.hasNext()){
			...
			if(temp instanceof ParsedDateHistogram){
				next = ((ParsedDateHistogram) temp);
				continue;
	...
	@Override
	public TimePeriodGroupByTable Sum(String col, String alias, String script) {
		if(null == this.aggCondition){
	...
	@Override
	public TimePeriodGroupByTable Sum(String col, String alias, String script, Map<String, Object> params) {
		if(null == this.aggCondition){
	...
	@Override
	public TimePeriodGroupByTable Avg(String col, String alias, String script) {
		if(null == this.aggCondition){
	...
	@Override
	public IGroupBy Avg(String col, String alias, String script, Map<String, Object> params) {
		if(null == this.aggCondition){
	...
	@Override
	public TimePeriodGroupByTable Max(String col, String alias, String script) {
		if(null == this.aggCondition){
	...
	@Override
	public TimePeriodGroupByTable Max(String col, String alias, String script, Map<String, Object> params) {
		if(null == this.aggCondition){
	...
	@Override
	public TimePeriodGroupByTable Min(String col, String alias, String script) {
		if(null == this.aggCondition){
	...
	@Override
	public TimePeriodGroupByTable Min(String col, String alias, String script, Map<String, Object> params) {
		if(null == this.aggCondition){
	...
	@Override
	public TimePeriodGroupByTable SelectAggCols(String...cols) {
		if(null != this.aggCondition) {
	...
	@Override
	public TimePeriodGroupByTable SelectAggScriptCols(String alias, String Script) {
		if(null != this.aggCondition) {
	...
	@Override
	public TimePeriodGroupByTable OrderAggCols(String orderCol, boolean desc) {
		if(null != this.aggCondition) {
	...
	@Override
	public TimePeriodGroupByTable AppendAggScriptCol(String alias, String script) {
		if(null != this.aggCondition) {
			logger.debug("select custom Script cols:" + alias);
			AggTimePeriodStatCondition temp = (AggTimePeriodStatCondition)this.aggCondition;
	...
	@Override
	public TimePeriodGroupByTable EndSelectAggCols(){
		if(null != this.aggCondition) {
	...
	@Override
	public TimePeriodGroupByTable setAliasMap(String col, String alias) {
	...
	@Override
	public TimePeriodGroupByTable AggSize(Integer size) {
		AggTimePeriodStatCondition temp = (AggTimePeriodStatCondition)this.aggCondition;
		if(null != temp){
			temp.size(size);
	...
	@Override
	public TimePeriodGroupByTable AggCalc(String alias, String script, String... aggCols) {
		throw new RuntimeException("还不支持");
	}

	@Override
	public <T> TimePeriodGroupByTable Having(String aggCol, LogicRelation relation, T value) {
		throw new RuntimeException("还不支持");
	}

	@Override
	public TimePeriodGroupByTable OrderGroup(String aggCol, boolean isDesc) {
		throw new RuntimeException("还不支持");
	}

	@Override
	public TimePeriodGroupByTable OrderGroup(String[] aggCols, boolean[] isDescs) {
		throw new RuntimeException("还不支持");
	}
	
	@Override
	public TimePeriodGroupByTable AggTopSum(String alias, String path) {
		this.rootPipleAggConditionList.add(new AggTopSumCondition(alias,path));
		return this;
	}

	@Override
	public TimePeriodGroupByTable AggTopAvg(String alias, String path) {
		this.rootPipleAggConditionList.add(new AggTopAvgCondition(alias,path));
		return this;
	}

	@Override
	public TimePeriodGroupByTable AggTopMax(String alias, String path) {
		this.rootPipleAggConditionList.add(new AggTopMaxCondition(alias,path));
		return this;
	}

	@Override
	public TimePeriodGroupByTable AggTopMin(String alias, String path) {
		this.rootPipleAggConditionList.add(new AggTopMinCondition(alias,path));
		return this;
	}
	
	@Override
	public <T> TimePeriodGroupByTable WhereAnd(String k, Object... vs) {
		if(null == boolCondition){
			boolCondition = new BoolCondition();
		}
	...
	@Override
	public <T> TimePeriodGroupByTable WhereAnd(String k, Collection<?> vs) {
		if(null == boolCondition){
			boolCondition = new BoolCondition();
		}
		boolCondition.And(k, vs);
	...
	@Override
	public <T> TimePeriodGroupByTable WhereOr(String k, Object... vs) {
		if(null == boolCondition){
			boolCondition = new BoolCondition();
		}
	...
	@Override
	public <T> TimePeriodGroupByTable WhereOr(String k, Collection<?> vs) {
		if(null == boolCondition){
			boolCondition = new BoolCondition();
		}
		boolCondition.Or(k, vs);
	...
	@Override
	public <T> TimePeriodGroupByTable WhereNot(String k, Object... vs) {
		if(null == boolCondition){
			boolCondition = new BoolCondition();
		}
	...
	@Override
	public <T> TimePeriodGroupByTable WhereNot(String k, Collection<?> vs) {
		if(null == boolCondition){
			boolCondition = new BoolCondition();
		}
		boolCondition.Not(k, vs);
	...
	@Override
	public TimePeriodGroupByTable WhereAndPrefix(String k, String v) {
		if(null == boolCondition){
			boolCondition = new BoolCondition();
		}
	...
	@Override
	public TimePeriodGroupByTable WhereAndWildcard(String k, String v) {
		if(null == boolCondition){
			boolCondition = new BoolCondition();
		}
	...
	@Override
	public TimePeriodGroupByTable WhereAndRegexp(String k, String v) {
		if(null == boolCondition){
			boolCondition = new BoolCondition();
		}
	...
	@Override
	public TimePeriodGroupByTable WhereAndFuzzy(String k, String v) {
		if(null == boolCondition){
			boolCondition = new BoolCondition();
		}
	...
	@Override
	public TimePeriodGroupByTable WhereOrPrefix(String k, String v) {
		if(null == boolCondition){
			boolCondition = new BoolCondition();
		}
	...
	@Override
	public TimePeriodGroupByTable WhereOrWildcard(String k, String v) {
		if(null == boolCondition){
			boolCondition = new BoolCondition();
		}
	...
	@Override
	public TimePeriodGroupByTable WhereOrRegexp(String k, String v) {
		if(null == boolCondition){
			boolCondition = new BoolCondition();
		}
	...
	@Override
	public TimePeriodGroupByTable WhereOrFuzzy(String k, String v) {
		if(null == boolCondition){
			boolCondition = new BoolCondition();
		}
	...
	public TimePeriodGroupByTable WhereNotPrefix(String k, String v) {
		if(null == boolCondition){
			boolCondition = new BoolCondition();
		}
	...
	@Override
	public TimePeriodGroupByTable WhereNotWildcard(String k, String v) {
		if(null == boolCondition){
			boolCondition = new BoolCondition();
		}
	...
	@Override
	public TimePeriodGroupByTable WhereNotRegexp(String k, String v) {
		if(null == boolCondition){
			boolCondition = new BoolCondition();
		}
	...
	@Override
	public TimePeriodGroupByTable WhereNotFuzzy(String k, String v) {
		if(null == boolCondition){
			boolCondition = new BoolCondition();
		}
